...
# The f indicates that the number should be formatted as a floating-point value.
# The e indicates that the number should be formatted as a floating-point value.
# Without f or e we get the scientific notation

#print in the desired format
print(f"Seconds since January 1, 1970: {'{:,.4f}'.format(epoch_time)} or {'{:,.2e}'.format(epoch_time)} in scientific notation")
